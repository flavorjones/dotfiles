...
s0_rotate_left_key = <Alt>Left
s0_rotate_left_button = Disabled
s0_rotate_right_key = <Alt>Right
...
s0_right_edge_threshold = 0
s0_top_edge_threshold = 0
s0_bottom_edge_threshold = 0
...
s0_highlight_color = #00000000
s0_highlight_border_color = #0000ffc8
...
[core]
s0_active_plugins = core;bailer;detection;composite;opengl;compiztoolbox;decor;place;session;vpswitch;gnomecompat;move;imgpng;unitymtgrabhandles;snap;regex;grid;resize;mousepoll;wall;animation;expo;workarounds;ezoom;staticswitcher;fade;scale;
...
s0_toggle_window_maximized_key = <Control><Alt><Super>Return
