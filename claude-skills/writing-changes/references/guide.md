...
Style Mike uses, learned from his Rails PRs:

- Wrap every code identifier in backticks: method names, class names, file names, error classes, code literals.
...
- Keep the tone matter-of-fact. State non-exploitability or limited impact plainly rather than dramatizing severity.
