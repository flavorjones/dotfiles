...
Specifically, Ligature mode is enabled in all buffers where `ligature-mode-turn-on' would do it.

With prefix ARG, enable Global Ligature mode if ARG is positive; otherwise, disable it.
