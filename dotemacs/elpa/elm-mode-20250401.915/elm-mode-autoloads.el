...
In addition to any hooks its parent mode `comint-mode' might have run, this mode runs the hook
`elm-interactive-mode-hook', as the final or penultimate step during initialization." t)
...
hook `elm-package-mode-hook', as the final or penultimate step during initialization." t)
...
`elm-mode-hook', as the final or penultimate step during initialization.
