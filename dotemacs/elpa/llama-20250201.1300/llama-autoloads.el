...
With prefix ARG, enable Global Llama-Fontify mode if ARG is positive; otherwise, disable it.

If called from Lisp, toggle the mode if ARG is `toggle'.
Enable the mode if ARG is nil, omitted, or is a positive number.
Disable the mode if ARG is a negative number.

Llama-Fontify mode is enabled in all buffers where `llama--turn-on-fontify-mode' would do it.
